	...
	<div id="content-left-in">
		<div class="miles">
			...
			<div class="breadcrumb">
				<a href="managemilestone.php?action=showproject&amp;id={$project.ID}"><img src="./templates/collabtive-ci/images/symbols/projects.png" alt="" />{$projectname|truncate:40:"...":true}</a>
			</div>
