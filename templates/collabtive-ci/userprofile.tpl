...
<tr>
	...
	{else}
		{if $user.gender == "f"}
		<div class="avatar-profile"><img src = "thumb.php?pic=templates/collabtive-ci/images/no-avatar-female.jpg&amp;width=122;" alt="" /></div>
		{else}
		<div class="avatar-profile"><img src = "thumb.php?pic=templates/collabtive-ci/images/no-avatar-male.jpg&amp;width=122;" alt="" /></div>
		{/if}
	{/if}
...
<div class="projects">
			<div class="headline">
				...
				<h2>
					<a href="myprojects.php" title="{#myprojects#}"><img src="./templates/collabtive-ci/images/symbols/projects.png" alt="" />{#projects#}</a>
				</h2>
			</div>
...
<div class="timetrack">
			<div class="headline">
				...
				<h2>
					<img src="./templates/collabtive-ci/images/symbols/timetracker.png" alt="" />{#report#}
				</h2>
			</div>
