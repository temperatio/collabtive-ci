...
<div class="msgs">
	...
	<span id = "deleted" style = "display:none;" class="info_in_red"><img src="templates/collabtive-ci/images/symbols/msgs.png" alt=""/>{#messagewasdeleted#}</span>
	</div>
...
<h1>{#mymessages#}</h1>
	...
	{section name= project loop=$myprojects}
			...
			<div class="headline">
				...
				<h2>
					<a href="managemessage.php?action=showproject&amp;id={$myprojects[project].ID}" title="{$myprojects[project].name|truncate:30:"...":true} / {#mymessages#}"><img src="./templates/collabtive-ci/images/symbols/projects.png" alt="" />{$myprojects[project].name|truncate:30:"...":true}</a>
				</h2>
			</div>
																			...
																			<tr>
																				...
																				<td class="thumb">
																				 	<a href = "{$myprojects[project].messages[message].files[file].datei}"{if $myprojects[project].messages[message].files[file].imgfile == 1} rel="lytebox[img{$myprojects[project].messages[message].ID}]" {elseif $myprojects[project].messages[message].files[file].imgfile == 2} rel = "lyteframe[text{$myprojects[project].messages[message].ID}]"{/if} title="{$myprojects[project].messages[message].files[file].name}">
																					 		...
																					 		{else}
																					 		<img src = "templates/collabtive-ci/images/files/{$myprojects[project].messages[message].files[file].type}.png" alt="" />
																					 		{/if}
																					</a>
																				</td>
