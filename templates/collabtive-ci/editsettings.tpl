...
<div class="neutral">
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
        ...
        <span class="info_in_green"><img src="templates/collabtive-ci/images/symbols/basecamp.png" alt=""/>{#importsuccess#}</span>
...
<h1>{#administration#}<span>/ {#systemadministration#}</span></h1>
			...
			<div class="headline">
				...
				<h2>
					<img src="./templates/collabtive-ci/images/symbols/system-settings.png" alt="" />{#systemadministration#}</a>
				</h2>
			</div>
...
<div class="content-spacer"></div>
			...
			<div class="headline">
				...
				<h2>
					<img src="./templates/collabtive-ci/images/symbols/basecamp.png" alt="" />{#import#}</a>
				</h2>
			</div>
...
<div class="content-spacer"></div>
			...
			<div class="headline">
				...
				<h2>
					<img src="./templates/collabtive-ci/images/symbols/msgs.png" alt="" />{#email#}</a>
				</h2>
			</div>
