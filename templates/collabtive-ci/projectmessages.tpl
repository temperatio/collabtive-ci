...
<div class="msgs">
	...
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
		{if $mode == "added"}
		<span class="info_in_green"><img src="templates/collabtive-ci/images/symbols/msgs.png" alt=""/>{#messagewasadded#}</span>
		{elseif $mode == "edited"}
		<span class="info_in_yellow"><img src="templates/collabtive-ci/images/symbols/msgs.png" alt=""/>{#messagewasedited#}</span>
		{elseif $mode == "replied"}
		<span class="info_in_green"><img src="templates/collabtive-ci/images/symbols/msgs.png" alt=""/>{#replywasadded#}</span>
		{/if}
	</div>
	{literal}
...
<h1>{$projectname}<span>/ {#messages#}</span></h1>
			...
			<div class="headline">
				...
				<h2>
					<img src="./templates/collabtive-ci/images/symbols/msgs.png" alt="" />{#messages#}
				</h2>
			</div>
								...
								<div class="accordion_content">
									<div class="acc-in">
										...
										{else}
												...
												<div class="avatar"><img src = "thumb.php?pic=templates/collabtive-ci/images/no-avatar-female.jpg&amp;width=80;" alt="" /></div>
												{else}
												<div class="avatar"><img src = "thumb.php?pic=templates/collabtive-ci/images/no-avatar-male.jpg&amp;width=80;" alt="" /></div>
												{/if}
										{/if}
																				...
																				<td class="thumb">
																				 	<a href = "{$messages[message].files[file].datei}"{if $messages[message].files[file].imgfile == 1} rel="lytebox[img{$messages[message].ID}]" {elseif $messages[message].files[file].imgfile == 2} rel = "lyteframe[text{$messages[message].ID}]"{/if} title="{$messages[message].files[file].name}">
																						{if $messages[message].files[file].imgfile == 1}
																				 		...
																				 		{else}
																						<img src = "templates/collabtive-ci/images/files/{$messages[message].files[file].type}.png" alt="" />
																				 		{/if}
																					</a>
																				</td>
