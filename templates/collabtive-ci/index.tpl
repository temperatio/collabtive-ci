...
<div id="content-left-in">
	...
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
        ...
        <span class="info_in_green"><img src="templates/collabtive-ci/images/symbols/projects.png" alt=""/>{#projectwasadded#}</span>
		{/if}

		{*for async display*}
		<span id = "closed" style = "display:none;" class="info_in_green"><img src="templates/collabtive-ci/images/symbols/projects.png" alt=""/>{#projectwasclosed#}</span>
		<span id = "deleted" style = "display:none;" class="info_in_red"><img src="templates/collabtive-ci/images/symbols/projects.png" alt=""/>{#projectwasdeleted#}</span>
	...
	<div class="projects">
			...
			<div class="headline">
				<a href="javascript:void(0);" id="projecthead_toggle" class="{$projectbar}" onclick = "toggleBlock('projecthead');"></a>
					...
					{/if}
				<h2>
					<a href="myprojects.php" title="{#myprojects#}"><img src="./templates/collabtive-ci/images/symbols/projects.png" alt="" />{#myprojects#}</a>
				</h2>
			</div>
			...
			<div class="block" id="projecthead" style = "{$projectstyle}">
				...
				<table id = "desktopprojects" cellpadding="0" cellspacing="0" border="0">
					...
					{/if}
					    <!-- DAMIAN START-->
						<tr {if $myprojects[project].daysleft < 0 && $myprojects[project].daysleft neq ""} class="marker-late"{elseif $myprojects[project].daysleft == 0} class="marker-today"{/if}>
						<!-- DAMIAN END-->
...
{if $tasknum > 0}
	<div class="tasks">
			...
			<div class="headline">
				...
				<h2>
					<a href="mytasks.php" title="{#mytasks#}"><img src="./templates/collabtive-ci/images/symbols/tasklist.png" alt="" />{#mytasks#}</a>
				</h2>
				...
				<table id = "desktoptasks" cellpadding="0" cellspacing="0" border="0">
					...
					<thead>
						<tr>
							...
							<th class="cf" onclick = "sortBlock('desktoptasks','daysleft');">{#daysleft#}</th>
							<!-- DAMIAN START-->
							<th class="cf" onclick = "sortBlock('desktoptasks','priority');">{#priority#}</th>
							<!-- DAMIAN END-->
							<th class="tools"></th>
						</tr>
					</thead>
			...
			<div class="headline">
				...
				<div class="wintools">
					...
					<div class = "progress" id = "progress" style = "display:none;">
						<img src = "templates/collabtive-ci/images/symbols/loader-cal.gif" />
					</div>
				</div>


				<h2>
					<img src="./templates/collabtive-ci/images/symbols/miles.png" alt="" />{#calendar#}
				</h2>
...
{if $msgnum > 0}
	<div class="msgs">
			...
			<div class="headline">
				...
				<h2>
					<a href="managemessage.php?action=mymsgs" title="{#mymessages#}"><img src="./templates/collabtive-ci/images/symbols/msgs.png" alt="" />{#mymessages#}</a>
				</h2>
			</div>
								...
								<div class="accordion_content">
									<div class="acc-in">
										...
										{else}
												...
												<div class="avatar"><img src = "thumb.php?width=80&amp;height=80&amp;pic=templates/collabtive-ci/images/no-avatar-female.jpg" alt="" /></div>
												{else}
												<div class="avatar"><img src = "thumb.php?width=80&amp;height=80&amp;pic=templates/collabtive-ci/images/no-avatar-male.jpg" alt="" /></div>
												{/if}										{/if}
																				...
																				<td class="thumb">
																				 	<a href = "{$messages[message].files[file].datei}" {if $messages[message].files[file].imgfile == 1} rel="lytebox[]" {elseif $messages[message].files[file].imgfile == 2} rel = "lyteframe[text]" {/if} title="{$messages[message].files[file].name}">
																						{if $messages[message].files[file].imgfile == 1}
																				 		...
																				 		{else}
																						<img src = "templates/collabtive-ci/images/files/{$messages[message].files[file].type}.png" alt="{$messages[message].files[file].name}" />
																				 		{/if}
																					</a>
																				</td>
