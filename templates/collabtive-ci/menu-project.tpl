<div class="headline">
<h2><a href="javascript:void(0);" id="status_toggle" class="{$statbar}" onclick = "toggleBlock('status');"><img src="./templates/collabtive-ci/images/symbols/projects.png" alt="" />
...
<br><a href = "manageproject.php?action=pdfreport&amp;id={$project.ID}" title = "{#report#}"><img src = "templates/collabtive-ci/images/symbols/files/application-pdf.png"></a>
<br />
{/if}
						</div></td>
						</tr>
