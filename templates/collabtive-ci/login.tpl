...
<div class="login">
	<div class="login-in">
		<div class="logo-name">
			<h1><a href = "http://collabtive.o-dyn.de/" title = "{$settings.name} Open Source project management"><img src="./templates/collabtive-ci/images/logo-a.png" alt="{$settings.name}"  /></a></h1>
