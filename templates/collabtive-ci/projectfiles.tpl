...
<div class="files">
	...
	<span id = "deleted" style = "display:none;" class="info_in_red"><img src="templates/collabtive-ci/images/symbols/files.png" alt=""/>{#filewasdeleted#}</span>
	</div>

	<div class="infowin_left" style = "display:none;" id = "systemmsg">
		{if $mode == "added"}
		<span class="info_in_green"><img src="templates/collabtive-ci/images/symbols/files.png" alt=""/>{#filewasadded#}</span>
		{elseif $mode == "edited"}
		<span class="info_in_yellow"><img src="templates/collabtive-ci/images/symbols/files.png" alt=""/>{#filewasedited#}</span>
		{elseif $mode == "folderadded"}
		<span class="info_in_green"><img src="templates/collabtive-ci/images/symbols/folder.png" alt=""/>{#folderwasadded#}</span>
		{elseif $mode == "folderedited"}
		<span class="info_in_yellow"><img src="templates/collabtive-ci/images/symbols/folder.png" alt=""/>{#folderwasedited#}</span>
		{elseif $mode == "folderdel"}
		<span class="info_in_red"><img src="templates/collabtive-ci/images/symbols/folder.png" alt=""/>{#folderwasdeleted#}</span>
		{/if}
	</div>
	{literal}
...
<h1>{$projectname}<span>/ {#files#}</span></h1>
			...
			<div class="headline">
				...
				<h2>
					<img src="./templates/collabtive-ci/images/symbols/folder-root.png" alt="" /><span id = "dirname">{#rootdir#}</span>
				</h2>
			</div>
