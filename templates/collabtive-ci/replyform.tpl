...
<div id="content-left">
	<div id="content-left-in">
		...
		<div class="breadcrumb">
			<a href="manageproject.php?action=showproject&amp;id={$project.ID}" title="{$project.name}"><img src="./templates/collabtive-ci/images/symbols/projects.png" alt="" />{$project.name|truncate:25:"...":true}</a>
			<a href="managetask.php?action=showproject&amp;id={$project.ID}"><img src="./templates/collabtive-ci/images/symbols/msgs.png" alt="" />{#messages#}</a>
			<a href="managetasklist.php?action=showtasklist&amp;id={$project.ID}&amp;tlid={$tasklist.ID}"><img src="./templates/collabtive-ci/images/symbols/msgs.png" alt="" />{$message.name|truncate:50:"...":true}</a><span>&nbsp;/...</span>
		</div>

		<h1 class="second"><img src="./templates/collabtive-ci/images/symbols/msgs.png" alt="" />{$message.name}</h1>
		{/if}
