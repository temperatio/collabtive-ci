...
<div class="tasks">
	...
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
	    ...
	    <span class="info_in_red"><img src="templates/collabtive-ci/images/symbols/tasklist.png" alt=""/>{#tasklistwasclosed#}</span>
	...
	{if $myprojects[project].tasknum}
			...
			<div class="headline">
				...
				<h2>
					<a href="managetask.php?action=showproject&amp;id={$myprojects[project].ID}" title="{$myprojects[project].name} / {#mytasks#}"><img src="./templates/collabtive-ci/images/symbols/projects.png" alt="" />{$myprojects[project].name|truncate:30:"...":true}</a>
				</h2>
			</div>
