...
<div class="tasks">
	...
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
		{if $mode == "edited"}
		<span class="info_in_yellow"><img src="templates/collabtive-ci/img/symbols/tasklist.png" alt=""/>{#tasklistwasedited#}</span>
		{/if}
	</div>
	{literal}
...
<h1 class="second"><img src="./templates/collabtive-ci/images/symbols/tasklist.png" alt="" />{$tasklist.name|truncate:40:"...":true}</h1>
	...
	<div id="descript" class="descript" style="display:none;">
		...
		<div class="content-spacer"></div>
			...
			<div class="headline">
				...
				<h2>
					<img src="./templates/collabtive-ci/images/symbols/tasklist.png" alt="" />{#newtasks#}</a>
				</h2>
			</div>
			...
			{if $userpermissions.tasks.add}
				<div id = "form_addtask" class="addmenue" style = "display:none;">
				    <!-- DAMIAN START-->
					{include file="addtask.tpl" assign="priorities"}
					<!-- DAMIAN END-->
				</div>
			{/if}
