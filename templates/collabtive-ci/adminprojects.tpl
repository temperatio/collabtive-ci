...
<div class="projects">
	...
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
		{if $mode == "assigned"}
		<span class="info_in_yellow"><img src="templates/collabtive-ci/images/symbols/system-settings.png" alt=""/>{#settingsedited#}</span>
        {elseif $mode == "deassigned"}
        <span class="info_in_red"><img src="templates/collabtive-ci/images/symbols/user-icon-male.png" alt=""/>{#userwasdeassigned#}</span>
		{elseif $mode == "added"}
...
<h1>{#administration#}<span>/ {#projectadministration#}</span></h1>
	...
	<div class="headline">
				...
				<h2>
					<img src="./templates/collabtive-ci/images/symbols/projects.png" alt="" />{#openprojects#}
				</h2>
			</div>
