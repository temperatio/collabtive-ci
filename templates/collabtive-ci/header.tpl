...
<link rel="shortcut icon" href="templates/collabtive-ci/images/favicon.ico" type="image/x-icon" />
...
{if $jsload3 == "lightbox"}
<link rel="stylesheet" href="templates/collabtive-ci/css/lytebox.css" type="text/css"  />
<script type="text/javascript" src="include/js/lytebox.php"></script>
{/if}
<link rel="stylesheet" type="text/css" href="templates/collabtive-ci/css/style_main.php"/>

<!--[if lte IE 7]>
<link rel="stylesheet" type="text/css" href="templates/collabtive-ci/css/style_iefix.css"/>
<![endif]-->
