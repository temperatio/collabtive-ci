...
<a href="managefile.php?action=showproject&amp;id={$project.ID}" ><img src="./templates/collabtive-ci/images/symbols/projects.png" alt="" />{$projectname|truncate:25:"...":true}</a>

</div>

<h1 class="second"><img src="./templates/collabtive-ci/images/symbols/files.png" alt="" />{$file.title|truncate:30:"...":true}</h1>
