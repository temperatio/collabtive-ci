...
<div class="tasks">
	...
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
		{if $mode == "added"}
		<span class="info_in_green"><img src="templates/collabtive-ci/images/symbols/task.png" alt=""/>{#taskwasadded#}</span>
		{elseif $mode == "edited"}
		<span class="info_in_yellow"><img src="templates/collabtive-ci/images/symbols/task.png" alt=""/>{#taskwasedited#}</span>
		{elseif $mode == "deleted"}
		<span class="info_in_red"><img src="templates/collabtive-ci/images/symbols/task.png" alt=""/>{#taskwasdeleted#}</span>
		{elseif $mode == "opened"}
		<span class="info_in_green"><img src="templates/collabtive-ci/images/symbols/task.png" alt=""/>{#taskwasopened#}</span>
		{elseif $mode == "closed"}
		<span class="info_in_red"><img src="templates/collabtive-ci/images/symbols/task.png" alt=""/>{#taskwasclosed#}</span>
		{elseif $mode == "assigned"}
		<span class="info_in_yellow"><img src="templates/collabtive-ci/images/symbols/task.png" alt=""/>{#taskwasassigned#}</span>
		{elseif $mode == "deassigned"}
		<span class="info_in_yellow"><img src="templates/collabtive-ci/images/symbols/task.png" alt=""/>{#taskwasdeassigned#}</span>
		{elseif $mode == "listadded"}
		<span class="info_in_green"><img src="templates/collabtive-ci/images/symbols/tasklist.png" alt=""/>{#tasklistwasadded#}</span>
        {elseif $mode == "listclosed"}
		<span class="info_in_red"><img src="templates/collabtive-ci/images/symbols/tasklist-done.png" alt=""/>{#tasklistwasclosed#}</span>
		{elseif $mode == "listdeleted"}
		<span class="info_in_red"><img src="templates/collabtive-ci/images/symbols/tasklist.png" alt=""/>{#tasklistwasdeleted#}</span>
		{elseif $mode == "listopened"}
		<span class="info_in_green"><img src="templates/collabtive-ci/images/symbols/tasklist.png" alt=""/>{#tasklistwasopened#}</span>
		{/if}

		{*for async display*}
		<span id = "added" style = "display:none;" class="info_in_green"><img src="templates/collabtive-ci/images/symbols/task.png" alt=""/>{#taskwasadded#}</span>
		<span id = "edited" style = "display:none;" class="info_in_yellow"><img src="templates/collabtive-ci/images/symbols/task.png" alt=""/>{#taskwasedited#}</span>
		<span id = "deleted" style = "display:none;" class="info_in_red"><img src="templates/collabtive-ci/images/symbols/task.png" alt=""/>{#taskwasdeleted#}</span>
		<span id = "opened" style = "display:none;" class="info_in_green"><img src="templates/collabtive-ci/images/symbols/task.png" alt=""/>{#taskwasopened#}</span>
		<span id = "closed" style = "display:none;" class="info_in_green"><img src="templates/collabtive-ci/images/symbols/task.png" alt=""/>{#taskwasclosed#}</span>
		<span id = "assigned" style = "display:none;" class="info_in_yellow"><img src="templates/collabtive-ci/images/symbols/task.png" alt=""/>{#taskwasassigned#}</span>
		<span id = "deassigned" style = "display:none;" class="info_in_yellow"><img src="templates/collabtive-ci/images/symbols/task.png" alt=""/>{#taskwasdeassigned#}</span>
		<span id = "listadded" style = "display:none;" class="info_in_green"><img src="templates/collabtive-ci/images/symbols/tasklist.png" alt=""/>{#tasklistwasadded#}</span>
        <span id = "listclosed" style = "display:none;" class="info_in_red"><img src="templates/collabtive-ci/images/symbols/tasklist-done.png" alt=""/>{#tasklistwasclosed#}</span>
		<span id = "listdeleted" style = "display:none;" class="info_in_red"><img src="templates/collabtive-ci/images/symbols/tasklist.png" alt=""/>{#tasklistwasdeleted#}</span>
		<span id = "listopened" style = "display:none;" class="info_in_green"><img src="templates/collabtive-ci/images/symbols/tasklist.png" alt=""/>{#tasklistwasopened#}</span>
...
{section name=list loop=$lists}
			...
			<div class="headline">
				...
				<h2>
					<a href="managetasklist.php?action=showtasklist&amp;id={$project.ID}&amp;tlid={$lists[list].ID}" title="{#tasklist#} {$lists[list].name}"><img src="./templates/collabtive-ci/images/symbols/tasklist.png" alt="" />{$lists[list].name}</a>
				</h2>
...
{*Done Tasklists*}
			...
			<div class="headline">
				...
				<h2>
					<img src="./templates/collabtive-ci/images/symbols/tasklist-done.png" alt="" />{#donetasklists#}
				</h2>
			</div>
