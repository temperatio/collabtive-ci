...
<div class="infowin_left" style = "display:none;" id = "systemmsg">
	{if $mode == "added"}
		<span class="info_in_green"><img src="templates/collabtive-ci/images/symbols/msg.png" alt=""/>{#messagewasadded#}</span>
		{elseif $mode == "edited"}
		<span class="info_in_yellow"><img src="templates/collabtive-ci/images/symbols/msg.png" alt=""/>{#messagewasedited#}</span>
		{elseif $mode == "deleted"}
		<span class="info_in_red"><img src="templates/collabtive-ci/images/symbols/msg.png" alt=""/>{#messagewasdeleted#}</span>
		{elseif $mode == "replied"}
		<span class="info_in_green"><img src="templates/collabtive-ci/images/symbols/msg_reply.png" alt=""/>{#replywasadded#}</span>
		{/if}
	</div>
	{literal}
...
<a href="manageproject.php?action=showproject&amp;id={$project.ID}"><img src="./templates/collabtive-ci/images/symbols/projects.png" alt="" />{$projectname|truncate:40:"...":true}</a>
<a href="managemessage.php?action=showproject&amp;id={$project.ID}"><img src="./templates/collabtive-ci/images/symbols/msgs.png" alt="" />{#messages#}</a>
</div>

<h1 class="second"><img src="./templates/collabtive-ci/images/symbols/msgs.png" alt="" />{$message.title|truncate:40:"...":true}</h1>
												...
												<tr>
													...
													<td class="thumb">
													 	<a href = "{$message.files[file].datei}"{if $message.files[file].imgfile == 1} rel="lytebox[img{$message.files[file].ID}]" {elseif $message.files[file].imgfile == 2} rel = "lyteframe[text{$message.files[file].ID}]"{/if} title="{$message.files[file].name}">
													 		...
													 		{else}
													 		<img src = "templates/collabtive-ci/images/files/{$message.files[file].type}.png" alt="{$message.files[file].name}" />
													 		{/if}
													 	</a>
													</td>
	...
	{if $replies > 0}
				...
				<h2>
					<img src="./templates/collabtive-ci/images/symbols/msgs.png" alt="" />{#replies#}</a>
				</h2>
			</div>
																			...
																			<tr>
																				...
																				<td class="thumb">
																				 	<a href = "{$replies[reply].files[file].datei}"{if $replies[reply].files[file].imgfile == 1} rel="lytebox[img{$replies[reply].files[file].ID}]" {elseif $replies[reply].files[file].imgfile == 2} rel = "lyteframe[text{$replies[reply].files[file].ID}]"{/if} title="{$replies[reply].files[file].name}">
																					 		...
																					 		{else}
																					 		<img src = "templates/collabtive-ci/images/files/{$replies[reply].files[file].type}.png" alt="" />
																					 		{/if}
																					</a>
																				</td>
																				<td class="rightmen" valign="top">
