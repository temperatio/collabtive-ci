...
<div class="infowin_left" style = "display:none;" id = "systemmsg">
		{if $mode == "added"}
		<span class="info_in_green"><img src="templates/collabtive-ci/images/symbols/miles.png" alt=""/>{#milestonewasadded#}</span>
		{elseif $mode == "edited"}
		<span class="info_in_yellow"><img src="templates/collabtive-ci/images/symbols/miles.png" alt=""/>{#milestonewasedited#}</span>
		{elseif $mode == "deleted"}
		<span class="info_in_red"><img src="templates/collabtive-ci/images/symbols/miles.png" alt=""/>{#milestonewasdeleted#}</span>
		{elseif $mode == "opened"}
		<span class="info_in_green"><img src="templates/collabtive-ci/images/symbols/miles.png" alt=""/>{#milestonewasopened#}</span>
		{elseif $mode == "closed"}
		<span class="info_in_red"><img src="templates/collabtive-ci/images/symbols/miles.png" alt=""/>{#milestonewasclosed#}</span>
		{/if}
	</div>
...
{*Milestones*}
			<div class="headline">
				...
				<h2>
					<img src="./templates/collabtive-ci/images/symbols/miles.png" alt="" />{#milestones#}
				</h2>
