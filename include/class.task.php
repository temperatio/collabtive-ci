...
class task
{
    ...
    function getTask($id)
    {
        $id = (int) $id;
        /* DAMIAN - START */
        $_priorities = array(1 => 'Lowest', 2 => 'Low', 3 => 'Medium', 4 => 'High', 5 => 'Highest');
        /* DAMIAN - END */
    ...
    public function getPriority($priority) {
    	...
    	switch($priority) {
    		case 1:
                $label = $langfile['Lowest'];
            break;
            case 2:
                $label = $langfile['Low'];
            break;
            case 3:
                $label = $langfile['Medium'];
            break;
            case 4:
                $label = $langfile['High'];
            break;
            case 5:
                $label = $langfile['Highest'];
            break;
    	}
        return $label;
    }
